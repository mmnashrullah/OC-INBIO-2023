...
NEXUS_BootstrapTrees_file = curr_dir + "\\BTSTRP UPGMA najas31.nexus"
NEWICK_Tree_file = curr_dir + "\\UPGMA najas31.nwk"
...
PAUP_block = """\
    begin paup;
      ...
      dset distance=P;
      bootstrap search=UPGMA nreps=100 conlevel=50 brlens=yes treefile='%s' format=Nexus;
    end
