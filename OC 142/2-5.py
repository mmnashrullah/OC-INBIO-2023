...
NEXUS_BootstrapTrees_file = curr_dir + "\\BTSTRP NJ najas31.nexus"
NEWICK_Tree_file = curr_dir + "\\NJ najas31.nwk"
...
PAUP_block = """\
    begin paup;
      ...
      dset distance=P; 
      bootstrap search=NJ nreps=1000 conlevel=50 treefile='%s' format=Nexus /bionj=yes;
    end
