...
NEXUS_BootstrapTrees_file = curr_dir + "\\BTSTRP ML najas31.nexus"
NEWICK_Tree_file = curr_dir + "\\ML najas31.nwk"
...
PAUP_block = """\
    begin paup;
      ...
      dset distance=ML; 
      bootstrap search=heuristic nreps=100 conlevel=50 treefile='%s' format=Nexus /start=stepwise swap=TBR;
    end
